                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="<?php echo(empty($task['id']) ? '/add' : '/edit') ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="username" type="text" class="form-control" name="username" value="<?php _textOut($task['username']) ?>" required autofocus>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type="email" class="form-control" name="email" value="<?php _textOut($task['email']) ?>" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea class="form-control w-100" name="text" id="text" rows="5"><?php _textOut($task['text']) ?></textarea>
                                </div>
                            </div>
                            <?php
